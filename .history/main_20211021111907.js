...
new Vue({
    ...
    data() {
        return {
            carList:[
                {id img:"https://media.istockphoto.com/photos/electric-sports-car-the-tesla-model-3-picture-id1277254968?k=6&m=1277254968&s=612x612&w=0&h=4j3WhZQD95BJyqOnML2sDatX9SFQomJclLyd5bbV3FU=", name:'Model 3',category:'Tesla',price:"$48,490",data:"2020-09-04"},
