...
new Vue({
    ...
    data: {
        // return {
            ...
            carCates:["Category","Tesla","Porsche","Toyota","Honda","Mazda","Mercedes-Benz","Lexus","Lamborghini","Audi","BMW"],
            selectCate:"Category",
            dd: false
        // }
    },
    computed : {
        select1() {
            console.log(this.selectCate == "Category");
            // console.log(this.selectCate == "1");
            // return this.selectCate == "1";
            // for (let i=0; i<this.carList.length; i++) {
                // if (this.selectCate == this.carList[i].category) {
                //     console.log(document.getElementById(i));
                // }
                // if (this.carList.category == this.selectCate) {
                    // return this.carList
