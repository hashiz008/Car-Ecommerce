...
new Vue({
    ...
    computed : {
        ...
        carList() {
            ...
            // if (this.selectSort == "Newest Arrivals") return this.carCate.sort((a,b) => console.log(new Date(b.data)));
            if (this.selectSort == "Newest Arrivals") return this.carCate.sort((a,b) => console.log(8new Date(a.data) < new Date(b.data) ? 1 : -1));
