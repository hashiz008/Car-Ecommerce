Vue.component("car-card", {
    ...
    <div id="car" class="mt-20 carCards flex flex-wrap justify-center">
            <div class="carCards2 mt-5 mr-4 rounded border-2 border-gray-300 flex flex-wrap size">
                <img class="pl-3 pt-3 img" v-bind:src="data.img">
                <div class="flex flex-wrap data">
                    <h5 class="pl-2 text-xl">{{data.name}}</h5>
                    <p class="category pb-2 pl-2">Category:{{data.category}}</p>
                    <p class="pb-3 pl-2">Price: {{data.price}}</p>
                    <p class="pl-2">Date: {{data.data}}</p>
                </div>
            </div>
        </div>
    </div>
